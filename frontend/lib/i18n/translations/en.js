...
const en = {
  ...
  adminStaff: {
    grantsOpportunities: {
      ...
      subtitle: 'Browse funding opportunities and recommend researchers whose expertise fits each call',
      addManual: 'Add Opportunity',
      importExcel: 'Import Excel',
      selected: '{count} selected',
      publish: 'Publish to Researchers',
      unpublish: 'Unpublish',
      publishSuccess: '{count} opportunity(ies) published to researchers',
      unpublishSuccess: '{count} opportunity(ies) unpublished',
      curationError: 'Failed to update publication status',
      createSuccess: 'Opportunity created successfully',
      importSuccess: 'Imported {count} opportunities',
      createTitle: 'New Grant Opportunity',
    },
  },
  ...
  researcher: {
    ...
    profile: {
      ...
      sections: {
        ...
        orcidAffiliations: {
          ...
          subtitle: 'Employment and education history from your linked ORCID record',
        },
        pastWork: {
          title: 'Past Work',
      ...
      pastWork: {
        ...
        publicationsHint: 'Live data from your linked ORCID record',
        reviewActivityFor: 'Review activity for {venue}',
        reviewOf: 'Review of "{title}"',
        reviewSubject: 'Subject reviewed',
        peerReview: 'Peer review',
        submittedOn: 'Submitted {date}',
        assignedOn: 'Assigned {date}',
        completedOn: 'Completed {date}',
        noOrcidLinked: 'Link an ORCID iD to your profile to display live data from ORCID.',
        orcidPeerReviews: 'ORCID peer reviews',
        ...
        emptyPublications: 'No publications found on your ORCID record.',
        emptyOrcidReviews: 'No peer reviews found on your ORCID record.',
      ...
      orcidKeywordsHint: 'Keywords synced from your ORCID profile (read-only). Edit keywords on ORCID to update.',
      orcidKeywordsLegend: 'Amber tags are keywords from your ORCID profile; teal tags are from your DACORIS profile.',
      orcidAffiliations: {
        work: 'Work',
        education: 'Education',
        present: 'Present',
        emptyWork: 'No employment history found on your ORCID record.',
        emptyEducation: 'No education history found on your ORCID record.',
      },
      add: 'Add',
    ...
    grantsDiscover: {
      ...
      summary: {
        ...
        recommended: '{count} Recommended to You',
      },
      ai: {
      ...
      apply: 'Apply',
      readMore: 'Read more',
      applicationsCount: '{count} institutional application(s)',
      colleaguesApplied: '{count} colleague(s) applied',
      recommendedBy: 'Recommended by {name}',
      recommendedResearchers: 'Recommended researchers',
      recommendResearcher: 'Recommend Researcher',
      badges: {
        recommended: 'Recommended',
        aiRecommended: 'AI Recommended',
        aiRecommendedScore: 'AI Recommended · {score}%',
        new: 'New',
      },
      recommendDialog: {
        title: 'Recommend Researchers',
        searchLabel: 'Select researchers',
        searchPlaceholder: 'Search by name, email, or department…',
        noteLabel: 'Why this opportunity fits (optional)',
        notePlaceholder: 'e.g. Expertise in climate resilience aligns with this call',
        cancel: 'Cancel',
        save: 'Save Recommendation',
        saveMultiple: 'Recommend {count} Researchers',
        recommendAll: 'Recommend to All',
        recommendAllConfirm: 'Recommend this opportunity to all institution researchers who are not already tagged?',
        alreadyRecommended: 'Already recommended',
        success: 'Researcher recommended for this opportunity',
        successMultiple: '{count} researchers recommended for this opportunity',
        successAll: 'Recommended to {count} researchers',
        alreadyAllRecommended: 'All researchers were already recommended for this opportunity',
        removed: 'Recommendation removed',
        removeConfirm: 'Remove this recommendation?',
      },
      ...
      filters: {
        ...
        clear: 'Clear',
        view: 'Show',
        viewAll: 'All opportunities',
        viewNew: 'New opportunities',
        viewMostApplied: 'Most applied',
        viewRecommended: 'Recommended to me',
        ...
        sortPriority: 'Recommended first',
        sortApplications: 'Most applications',
    ...
    grantsProposals: {
      ...
      status: {
        ...
        returned: 'Revision Requested',
        submitted: 'Submitted',
        internal_review: 'Eligibility Review',
        under_review: 'Under Review',
        approved: 'Approved',
        applying: 'Applying to Funder',
        awarded: 'Funder Awarded',
      ...
      groups: {
        ...
        approved: { label: 'Approved', hint: 'Ready to apply to funder' },
        funding: { label: 'External Funding', hint: 'Funder application & outcome' },
        declined: { label: 'Not Awarded', hint: 'Declined proposals' },
      },
      funding: {
        ...
        uploadDoc: 'Upload award letter or document',
        update: 'Update funding',
        save: 'Save',
        saving: 'Saving…',
      ...
      collab: {
        ...
        inviteSuccess: '{count} invitation(s) sent successfully.',
    ...
    proposalWorkspace: {
      ...
      workflow: {
        ...
        approved: 'Institutionally Approved',
        applying: 'Applying to External Funder',
        fundingUnsuccessful: 'Funding Unsuccessful',
        underReview: '{stage}',
    ...
    grantsTracker: {
      title: 'Grant Tracker',
      subtitle: 'Track institutionally approved proposals through external grant application — submission, funder outcome, and award.',
      refresh: 'Refresh',
      errorLoad: 'Failed to load approved grant applications',
      searchPlaceholder: 'Search by proposal, opportunity, or funder…',
      stats: {
        total: 'Total',
        ready: 'Ready to Apply',
        applying: 'Submitted to Funder',
        awarded: 'Awarded',
      ...
      table: {
        proposal: 'Proposal',
        opportunity: 'Grant Opportunity',
        grantInstitution: 'Grant Institution',
        approvedAt: 'Approved',
        application: 'Funder Application',
        deadline: 'Deadline',
        status: 'Status',
        actions: 'Actions',
      },
      ...
      empty: {
        ...
        subtitle: 'Proposals appear here once they are institutionally approved and ready for external grant application.',
        viewProposals: 'My Proposals',
      },
      noResults: 'No applications match your filters',
      actions: {
        open: 'Open proposal',
        startApplication: 'Start grant application',
        updateOutcome: 'Update outcome',
        viewAward: 'View award',
      },
      funding: {
        startTitle: 'Start Grant Application',
        outcomeTitle: 'Update Funder Outcome',
        statusLabel: 'Status',
        funder: 'Grant institution / funder',
        amount: 'Award amount',
        currency: 'Currency',
        notes: 'Notes (optional)',
        save: 'Save',
        saving: 'Saving…',
        cancel: 'Cancel',
        success: 'Grant application status updated',
        error: 'Failed to update grant application status',
        amountRequired: 'Award amount is required when marking as awarded',
      },
      status: {
