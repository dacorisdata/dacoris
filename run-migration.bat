@echo off
REM Run database migration using Docker (Windows)
REM This script executes the migration from within the backend container

echo Running collaborator invitation migration...

REM Execute migration using docker exec with psql
